    ...
    <Router>
      <GlobalContext.Provider value={{loading, setLoading, isSignedIn, setIsSignedIn, currentUser, setCurrentUser }}>
        <Routes>
          ...
          <Route path='/org' element={!loading && <Private><OrgMainPage /></Private>} />
          <Route path='/system' element={!loading && <Private><SetMainPage /></Private>} />
          <Route path='/master' element={!loading && <Private><MstMainPage /></Private>} />
          <Route path='/sales' element={!loading && <Private><SalesMainPage /></Private>} />
        </Routes>
