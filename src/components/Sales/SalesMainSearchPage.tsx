...
import { searchPropectParams } from '../../lib/api/prospect';
...
type Props = {
  search: searchPropectParams;
  setSearch: (search: searchPropectParams) => void;
  show: boolean;
  close: () => void;
}
const SalesMainSearchPage = (props: Props) => {
  ...
  const handleOnClick = () => {
    ...
    const params: searchPropectParams = {
      confirmed: confirmed,
      createdAt: createdAt,
  ...
  // 画面編集
  return (
    <Box component='div' sx={{ m: 3, backgroundColor: '#fff', height: 'auto', width: 'auto' }}>
      ...
      <Box component='div' sx={{ display: 'flex', justifyContent: 'space-between' }}>
        ...
        <Button color="primary" endIcon={<KeyboardArrowUpIcon />} onClick={(e) => props.close()}>Close</Button>
      </Box>
